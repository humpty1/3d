...
namespace tst3d
{
...

    {
        ...
        public Graph3D(string name
                      , string xNm
                      , string yNm
                      , string zNm
                      , int p):  base (name,700/ut.SZ.X_BUTTON - 2)
        {                 
            this.Name = "Form1";
            ...
            pB.CustomEndCap = new AdjustableArrowCap(4, 6);
        ...
        int readFile (string flNm){
          ...
          try {
                ...
                while (!sr.EndOfStream)
                {
                    ...
                    if (ss.Length >= 3)  {        /// becouse x, y, z only 3 coors
                       ...
                       _x.Add(r);                             /// список для   накапливания строчек
                                                  gbl.log.WriteLine (IMPORTANCELEVEL.Debug,"mapping x :{0}", (string)x)  ;
                                                  gbl.log.WriteLine (IMPORTANCELEVEL.Debug,"mapping y :{0}", (string)y);
                                                  gbl.log.WriteLine (IMPORTANCELEVEL.Debug,"mapping z :{0}", (string)z   );
                    }
                    else 
            ...
            gbl.log.WriteLine ("*** readFile: error while reading data file. line :'{0}'", line);
...
//            this.Controls.Add(this.vScrollBar1);
                   Panel rightUp  = new Panel();  // хочу приподнть вертикальный скролбар справа.
                   rightUp.Size = new System.Drawing.Size(17, 451);
                                                                             //
            //                                                               //  вправо положил не скрол бар, как раньше,
                    Panel p1 = new Panel();                                  //  а невидимую панель rightUp (в которую положил скролбар)
                    p1.Size = new  System.Drawing.Size(  17, ut.SZ.Y+15);    //    вниз панели положил еще одну пустую панель,
                    p1.Dock = DockStyle.Bottom;                              //    чтобы  скролбар поднять над
                    this.vScrollBar1.Dock   = DockStyle.Fill;                //    кнопкой выхода
                    rightUp.Dock  =  DockStyle.Right;                        //
                    rightUp.Controls.Add(this.vScrollBar1);
                    rightUp.Controls.Add(p1);
                    this.Controls.Add(rightUp);
