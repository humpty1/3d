...
//        static public ArgFlg  expF ;
      ...
      //  static public ArgFloatMM  perCent ;
        ...
        static public ArgStr  xNm ;  // имя файла с точками
        static public ArgStr  yNm ;  // имя файла с точками
        static public ArgStr  zNm ;  // имя файла с точками
...
//           expF   =  new ArgFlg(false, "e",  "expFunc",   "new func");
           ...
           xNm    =  new ArgStr("x", "xNm", "xName", "x-axis label", "XNM");
           yNm    =  new ArgStr("y", "yNm", "yName", "y-axis label", "YNM");
           zNm    =  new ArgStr("z", "zNm", "zName", "z-axis label", "ZNM");
         //  flNm.required = true;
/*
...
//            Application.SetCompatibleTextRenderingDefault(false);
           ...
           for (int i = 0; i<args.Length; i++){
             if (hlpF.check(ref i, args))
               ...
               ;
             else if (xNm.check(ref i, args))
               ;
             else if (yNm.check(ref i, args))
               ;
             else if (zNm.check(ref i, args))
               ;
           }
           ...
           using (LOGGER Logger = new LOGGER(LOGGER.uitoLvl(logLvl))){
              ...
              Graph3D x = new Graph3D("3d example", xNm, yNm, zNm, 10);
